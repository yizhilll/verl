{
    ...
    if [[ ${main_woker_id} -eq $worker_id ]]; then
        python3 -m verl.trainer.main_ppo \
            ...
            actor_rollout_ref.model.path=/map-vepfs/huggingface/models/Qwen/Qwen2.5-7B-base \
            ...
            algorithm.kl_ctrl.kl_coef=0.00000001 \
            ...
            trainer.experiment_name='qwen2_7b_math_rfpp_tbsz-1024_Bo8' \
